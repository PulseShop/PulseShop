    ...
    <MobileShell nav={false}>
      <div className="flex min-h-[80dvh] flex-col items-center justify-center gap-4 px-8 text-center">
        ...
        <div className="mt-1 flex flex-wrap items-center justify-center gap-2">
          ...
          <Link
            to="/"
            className="flex items-center gap-2 rounded-btn border border-line bg-card px-5 py-2.5 text-sm font-bold text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-card"
          >
